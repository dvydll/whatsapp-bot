 ...
 * @param {import("baileys").WASocket} params.sock - Socket de Baileys
 * @param {Object} params.economy - Módulo de economía
 * @param {Object} params.config - Configuración del grupo (welcome, bngp, antilink, etc.)
...
export {
  createPermissions, esAdminFlexible
}
