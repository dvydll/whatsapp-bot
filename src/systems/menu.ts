...
import { prefixo } from '../core/config'

/**
 * Genera un banner de sección
 * @param title - Título de la sección
 * @returns Banner formateado
 */
const sectionBanner = (title: string): string => `╭
   ❍  ${title}  ❐
╰`;

/**
 * Sistema de menú
 * @param timeFt - Hora formateada
 * @param Bot - Nombre del bot
 * @param sender - JID del usuario
 * @param groupName - Nombre del grupo
 * @param groupMembers - Número de miembros
 * @returns Menú formateado
 */
export const menu = (
  timeFt: string,
  Bot: string,
...
│✦ ➮ Grupo: ${groupName}
│✦ ➮ Nº Participantes: ${groupMembers?.length ?? 0}
╰━━━━━─「✪」─━━━━━
